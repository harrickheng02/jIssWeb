...
#### Scenario: Reader finds merge checklist link

- **WHEN** a contributor reads the workflow section of `README.md`
- **THEN** they SHALL find a reference to `docs/engineering/pr-merge-checklist.md`
