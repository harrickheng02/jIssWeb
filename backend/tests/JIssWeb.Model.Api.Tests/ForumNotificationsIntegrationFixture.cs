...
public sealed class ForumNotificationsIntegrationFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        DatabaseName = "model_nf_" + Guid.NewGuid().ToString("N");
...
[CollectionDefinition("ForumNotifications")]
public class ForumNotificationsCollection : ICollectionFixture<ForumNotificationsIntegrationFixture>
{
}
